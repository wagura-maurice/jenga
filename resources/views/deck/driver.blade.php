            ...
            <div class="col-md-12">
                    ...
                    <div class="panel-body ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="text" name="server" id="server" class="form-control"
                                        placeholder="ex: localhost" value="localhost" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="text" name="database" id="database" class="form-control"
                                        placeholder="ex: school_db" value="microfinance_v1" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="text" name="username" id="username" class="form-control"
                                        placeholder="ex: root" value="root" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="password" name="password" id="password" class="form-control"
                                        placeholder="ex: mypass" value="Database@2020" />
                                </div>
                            </div>
                            <div class="form-group">

                                <div class="col-md-6 m-t-10">
                                    <input type="hidden" class="form-control" placeholder="" name="script"
                                        id="script" />
                                </div>
                            </div>
                        ...
                        <form id="model_form">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="hidden" class="form-control" placeholder="" name="model_script"
                                        id="model_script" />

                                    <input type="hidden" class="form-control" placeholder="" name="model_name"
                                        id="model_name" />
                        ...
                        <form id="controller_form">
                            <input type="hidden" class="form-control" placeholder="" name="controller_script"
                                id="controller_script" />

                            <input type="hidden" class="form-control" placeholder="" name="controller_name"
                                id="controller_name" />

                        </form>
                        <form id="table_form">
                            <input type="hidden" class="form-control" placeholder="" name="header_script"
                                id="header_script" />

                            <input type="hidden" class="form-control" placeholder="" name="row_name" id="row_name" />

                            <input type="hidden" class="form-control" placeholder="" name="row_field_names"
                                id="row_field_names" />

                            <input type="hidden" class="form-control" placeholder="" name="row_input_cased_name"
                                id="row_input_cased_name" />


                            <input type="hidden" class="form-control" placeholder="" name="row_parents"
                                id="row_parents" />


                            <input type="hidden" class="form-control" placeholder="" name="table_name"
                                id="table_name" />

                            <input type="hidden" class="form-control" placeholder="" name="module_table_name"
                                id="module_table_name" />

                            <input type="hidden" class="form-control" placeholder="" name="table_module_name"
                                id="table_module_name" />

                            <input type="hidden" class="form-control" placeholder="" name="row_index_types"
                                id="row_index_types" />

                            <input type="hidden" class="form-control" placeholder="" name="row_index_values"
                                id="row_index_values" />

                            <input type="hidden" class="form-control" placeholder="" name="row_keys" id="row_keys" />
                            <input type="hidden" class="form-control" placeholder="" name="row_is_requireds"
                                id="row_is_requireds" />
                            <input type="hidden" class="form-control" placeholder="" name="row_input_types"
                                id="row_input_types" />

                            <input type="hidden" class="form-control" placeholder="" name="row_field_sections"
                                id="row_field_sections" />

                            <input type="hidden" class="form-control" placeholder=""
                                name="row_field_sections_description" id="row_field_sections_description" />

                            <input type="hidden" class="form-control" placeholder="" name="row_form_type"
                                id="row_form_type" />

                            <input type="hidden" class="form-control" placeholder="" name="row_sections_name"
                                id="row_sections_name" />

                            <input type="hidden" class="form-control" placeholder="" name="row_sections_description"
                                id="row_sections_description" />


                        </form>
                        <form id="form_form">
                            <input type="hidden" class="form-control" placeholder="" name="form_script"
                                id="form_script" />

                            <input type="hidden" class="form-control" placeholder="" name="field_names"
                                id="field_names" />

                            <input type="hidden" class="form-control" placeholder="" name="input_cased_name"
                                id="input_cased_name" />

                            <input type="hidden" class="form-control" placeholder="" name="keys" id="keys" />
                            <input type="hidden" class="form-control" placeholder="" name="is_requireds"
                                id="is_requireds" />

                            <input type="hidden" class="form-control" placeholder="" name="values" id="values" />

                            <input type="hidden" class="form-control" placeholder="" name="parent_modules"
                                id="parent_modules" />

                            <input type="hidden" class="form-control" placeholder="" name="index_types"
                                id="index_types" />

                            <input type="hidden" class="form-control" placeholder="" name="field_types"
                                id="field_types" />

                            <input type="hidden" class="form-control" placeholder="" name="form_name"
                                id="form_name" />

                            <input type="hidden" class="form-control" placeholder="" name="module_form_name"
                                id="module_form_name" />

                            <input type="hidden" class="form-control" placeholder="" name="form_module_name"
                                id="form_module_name" />

                            <input type="hidden" class="form-control" placeholder="" name="input_types"
                                id="input_types" />

                            <input type="hidden" class="form-control" placeholder="" name="field_sections"
                                id="field_sections" />

                            <input type="hidden" class="form-control" placeholder="" name="field_sections_description"
                                id="field_sections_description" />

                            <input type="hidden" class="form-control" placeholder="" name="form_type"
                                id="form_type" />

                            <input type="hidden" class="form-control" placeholder="" name="sections_name"
                                id="sections_name" />

                            <input type="hidden" class="form-control" placeholder="" name="sections_description"
                                id="sections_description" />


                        </form>
                        <form id="report_form">
                            <input type="hidden" class="form-control" placeholder="" name="report_header_script"
                                id="report_header_script" />

                            <input type="hidden" class="form-control" placeholder="" name="report_script"
                                id="report_script" />

                            <input type="hidden" class="form-control" placeholder="" name="report_row_name"
                                id="report_row_name" />

                            <input type="hidden" class="form-control" placeholder="" name="report_name"
                                id="report_name" />

                            <input type="hidden" class="form-control" placeholder="" name="module_report_name"
                                id="module_report_name" />

                            <input type="hidden" class="form-control" placeholder="" name="report_module_name"
                                id="report_module_name" />
                            <input type="hidden" class="form-control" placeholder="" name="report_row_index_types"
                                id="report_row_index_types" />

                            <input type="hidden" class="form-control" placeholder="" name="report_row_index_values"
                                id="report_row_index_values" />

                            <input type="hidden" class="form-control" placeholder="" name="report_row_field_names"
                                id="report_row_field_names" />
                            <input type="hidden" class="form-control" placeholder="" name="report_row_input_types"
                                id="report_row_input_types" />
                        ...
                        <form id="menu_form">
                            ...
                            <input type="hidden" class="form-control" placeholder="" name="menu_controller"
                                id="menu_controller" />
                    ...
                    <div class="panel-body ">
                        ...
                        <form id="usersaccountsroles_form">
                            ...
                            <input type="hidden" name="user_account"
                                value="{{ $driversdata['usersaccounts'][0]->id }}" />
                        ...
                        <form class="form-horizontal" id="modules_form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="text" name="_name" id="module_name" class="form-control"
                                        placeholder="ex: Users" />
                                    <input type="hidden" name="name" id="_module_name" class="form-control"
                                        placeholder="ex: Users" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <textarea class="form-control" name="description" id="module_description" placeholder="ex : Basic User Details"
                                        rows="3"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="text" name="notification_title" id="notification_title"
                                        class="form-control" placeholder="ex: User Registration" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 m-t-10">Notification Description</label>
                                <div class="col-md-6 m-t-10">
                                    <textarea class="form-control" placeholder="ex: New User was Registered..." rows="3"
                                        name="notification_description" id="notification_description"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <textarea class="form-control" disabled="disabled"
                                        placeholder="ex : Please Review You Details then click the button below" name="completion_message"
                                        id="completion_message" rows="3"></textarea>
                    ...
                    <div class="panel-body ">
                        <form class="form-horizontal" id="_sections_form">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="text" name="section_name" id="section_name" class="form-control"
                                        placeholder="ex : Basic Details " />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 m-t-10">Description</label>
                                <div class="col-md-6 m-t-10">
                                    <textarea class="form-control" name="section_description" id="section_description"
                                        placeholder="ex : Basic User Details" rows="3"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <button type="button" id="add_section" onclick="addSection()"
                                        class="btn btn-sm btn-primary">Add Section</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="panel-body ">
                        <form class="form-horizontal" id="fields_form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <select class="form-control" onchange="fieldType()" id="field_type"
                                        name="field_type">
                                        <option value="">Select Type</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="checkbox" value="1" name="is_index" onchange="enableIndex()"
                                        id="is_index" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <select class="form-control" disabled name="index_type" id="index_type"
                                        onchange="enableParentModules()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="text" name="parent_module_table" id="parent_module_table"
                                        class="form-control" placeholder="table" value="" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <input type="text" name="value" id="value" class="form-control"
                                        placeholder="ex: value 1,value 2" value="" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 m-t-10"></label>
                                <div class="col-md-6 m-t-10">
                                    <button type="button" id="add_field" name="add_field" onclick="addField()"
                                        class="btn btn-sm btn-primary">Add Field</button>
                                </div>
                            </div>
                ...
                <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                    ...
                    <div class="panel-body ">
                        <form class="form-horizontal" id="chart_form">
                            <input type="hidden" class="form-control" placeholder="" name="chart_module_name"
                                id="chart_module_name" />

                            <input type="hidden" class="form-control" placeholder="" name="chart_script"
                                id="chart_script" />

                            <input type="hidden" class="form-control" placeholder="" name="module_chart_name"
                                id="module_chart_name" />

                            <input type="hidden" class="form-control" placeholder="" name="module_chart_name_"
                                id="module_chart_name_" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-10">
                                    <textarea class="form-control" name="chart_description" id="chart_description"
                                        placeholder="ex : A Pie Chart Showing Number of Users activity Per Day" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 m-t-10">Add To Dashboard</label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 m-t-10"></label>
                                <div class="col-md-6 m-t-10">
                                    <button type="button" class="btn btn-sm btn-primary" name="add_chart"
                                        id="add_chart">Add Chart</button>
                                </div>
                            </div>
                ...
                <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                    ...
                    <div class="panel-body ">
                        <div class="row">
                            <div class="col-md-6 m-t-10">
                                <button type="button" class="btn btn-sm btn-primary" name="start_engine"
                                    id="start_engine" onclick="startEngine()">Start Engine</button>
                            </div>
                            ...
                            <div class="col-md-6 m-t-10">
                                <div class="form-group">
                                    ...
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-inverse" style="width: 0%"
                                            id="database_progress">Creating Database</div>
                                    </div>
                                </div>

                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-inverse" id="model_progress" style="width: 0%">
                                        Creating Model</div>
                                </div>
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-inverse" id="controller_progress"
                                        style="width: 0%">Creating Controller</div>
                                </div>
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-inverse" id="table_progress" style="width: 0%">
                                        Creating Table</div>
                                </div>
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-inverse" id="form_progress" style="width: 0%">
                                        Creating Form</div>
                                </div>
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-inverse" id="edit_form_progress"
                                        style="width: 0%">Creating Editing Form</div>
                                </div>

                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-inverse" id="report_progress"
                                        style="width: 0%">Creating Report</div>
                                </div>
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-inverse" id="chart_progress" style="width: 0%">
                                        Creating Chart</div>
                                </div>
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-inverse" id="menu_progress" style="width: 0%">
                                        Creating Routes</div>
                                </div>
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-inverse" id="module_progress"
                                        style="width: 0%">Creating Modules</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function addField() {
        ...
        if (fieldName != "") {
            ...
            $("#fields_tbody").append("<tr><td>" + fieldName + "</td><td>" + fieldType + "</td><td>" + isIndex +
                "</td><td>" + indexType + "</td><td>" + parentModule + "</td><td></td></tr>");
            $("#fields_form")[0].reset();
    ...
    function createDatabase() {
        if (fieldData.length > 0 && $("#module_name").val() != "") {
            var script = "create table " + getFormattedName($("#module_name").val()) +
            ...
            for (var r = 0; r < fieldData.length; r++) {
                ...
                if (fields["index_type"] == "unique_key") {
                    ...
                    fieldScript += " unsigned not null,foreign key(" + getFormattedName(fields["field_name"]) +
                        ") references " + fields["parent_module_table"] + "(id) on delete restrict on update cascade,";
                } else {
                    fieldScript += ",";
                }
                script += fieldScript;
    ...
    function createModel() {
        ...
        for (var k = 0; k < fieldData.length; k++) {
            ...
            if (fieldData[k]["index_type"] == "foreign_key") {
                ...
                script += "\n\t\treturn $this->belongsTo(" + fieldData[k]["parent_module"] + "::class, '" +
                    getFormattedName(fieldData[k]["field_name"]).toLowerCase() + "');";
                script += "\n\t}";
            }
        }
        script += "\n}";
    ...
    function createController() {
        ...
        for (var k = 0; k < fieldData.length; k++) {
            ...
            if (fieldData[k]["index_type"] == "foreign_key") {
                script += "\n\t\t$" + moduleName.toLowerCase() + "data['" + getNameCase(fieldData[k]["parent_module"])
                    .toLowerCase() + "']=" + getNameCase(fieldData[k]["parent_module"]) + "::all();";
            }
        }
        ...
        script += "\n\t\tif(isset($" + moduleName.toLowerCase() + "data['usersaccountsroles'][0]) && $" + moduleName
            .toLowerCase() + "data['usersaccountsroles'][0]['_add']==0&&$" + moduleName.toLowerCase() +
            "data['usersaccountsroles'][0]['_list']==0&&$" + moduleName.toLowerCase() +
            "data['usersaccountsroles'][0]['_edit']==0&&$" + moduleName.toLowerCase() +
            "data['usersaccountsroles'][0]['_edit']==0&&$" + moduleName.toLowerCase() +
            "data['usersaccountsroles'][0]['_show']==0&&$" + moduleName.toLowerCase() +
            "data['usersaccountsroles'][0]['_delete']==0&&$" + moduleName.toLowerCase() +
            "data['usersaccountsroles'][0]['_report']==0){";
        script += "\n\t\t\treturn view('admin.error.denied',compact('" + moduleName.toLowerCase() + "data'));";
        script += "\n\t\t}else{"
        script += "\n\t\t\treturn view('admin." + formattedName + ".index',compact('" + moduleName.toLowerCase() +
            "data'));";
        script += "\n\t\t}";
        script += "\n\t}";
        ...
        script += "\n\t\tif(isset($" + moduleName.toLowerCase() + "data['usersaccountsroles'][0]) && $" + moduleName
            .toLowerCase() + "data['usersaccountsroles'][0]['_add']==0){";
        script += "\n\t\t\treturn view('admin.error.denied',compact('" + moduleName.toLowerCase() + "data'));";
        script += "\n\t\t}else{"
        script += "\n\t\t\treturn view('admin." + formattedName + ".create',compact('" + moduleName.toLowerCase() +
            "data'));";
        script += "\n\t\t}";
        script += "\n\t}";
        script += "\n";
        ...
        for (var r = 0; r < fieldData.length; r++) {
            ...
            if (fields["input_type"] == "date") {
                script += "->orWhereBetween('" + fieldName + "',[$request->get('" + fieldName +
                    "from'),$request->get('" + fieldName + "to')])";
        ...
        script += "\n\t\tif(isset($" + moduleName.toLowerCase() + "data['usersaccountsroles'][0]) && $" + moduleName
            .toLowerCase() + "data['usersaccountsroles'][0]['_report']==0){";
        script += "\n\t\t\treturn view('admin.error.denied',compact('" + moduleName.toLowerCase() + "data'));";
        script += "\n\t\t}else{"
        script += "\n\t\t\treturn view('admin." + formattedName + ".report',compact('" + moduleName.toLowerCase() +
            "data'));";
        script += "\n\t\t}";
        script += "\n\t}";
        script += "\n";
        ...
        for (var r = 0; r < fieldData.length; r++) {
            ...
            if (fields["input_type"] == "image") {
                script += "\n\t\t$" + moduleName.toLowerCase() + "->" + fieldName +
                    "=time() . '_' . rand(1000, 9999) . '.jpg';";
            } else {
        ...
        script += "\n\t\tif(isset($" + moduleName.toLowerCase() + "data['usersaccountsroles'][0]) && $" + moduleName
            .toLowerCase() + "data['usersaccountsroles'][0]['_show']==1){";
        script += "\n\t\t\ttry{";
        ...
        for (var r = 0; r < fieldData.length; r++) {
            ...
            if (fields["input_type"] == "image") {
                ...
                script += "\n\t\t\t$" + casedFieldName + "Image->move('uploads/images',$" + moduleName.toLowerCase() +
                    "->" + fieldName + ");";
        ...
        script += "\n\t\t\tcatch(Exception $e){";
        script += "\n\t\t\t\t\t$response['status']='0';";
        script += "\n\t\t\t\t\t$response['message']='An Error occured while attempting to add " + $("#module_name")
        ...
        script += "\n\t\tif(isset($" + moduleName.toLowerCase() + "data['usersaccountsroles'][0]) && $" + moduleName
            .toLowerCase() + "data['usersaccountsroles'][0]['_edit']==0){";
        script += "\n\t\t\treturn view('admin.error.denied',compact('" + moduleName.toLowerCase() + "data'));";
        script += "\n\t\t}else{"
        script += "\n\t\treturn view('admin." + formattedName.toLowerCase() + ".edit',compact('" + moduleName
            .toLowerCase() + "data','id'));";
        script += "\n\t\t}";
        script += "\n\t}";
        ...
        script += "\n\t\tif(isset($" + moduleName.toLowerCase() + "data['usersaccountsroles'][0]) && $" + moduleName
            .toLowerCase() + "data['usersaccountsroles'][0]['_show']==0){";
        script += "\n\t\t\treturn view('admin.error.denied',compact('" + moduleName.toLowerCase() + "data'));";
        script += "\n\t\t}else{"
        script += "\n\t\treturn view('admin." + formattedName.toLowerCase() + ".show',compact('" + moduleName
            .toLowerCase() + "data','id'));";
        script += "\n\t\t}";
        script += "\n\t}";
        ...
        script += "\n\t\t$" + moduleName.toLowerCase() +
            "data['usersaccountsroles']=UsersAccountsRoles::where([['user_account','=',$user[0]['user_account']],['module','=',$module[0]['id']]])->get();";
        script += "\n\t\tif(isset($" + moduleName.toLowerCase() + "data['usersaccountsroles'][0]) && $" + moduleName
            .toLowerCase() + "data['usersaccountsroles'][0]['_delete']==1){";
        script += "\n\t\t\t$" + moduleName.toLowerCase() + "->delete();";
        script += "\n\t\t}";
        script += "return redirect('admin/" + moduleName.toLowerCase() + "')->with('success','" + $("#module_name")
    ...
    function createTable() {
        ...
        for (var r = 0; r < fieldData.length; r++) {
            ...
            if (r < 8) {
                ...
                headerScript += "\n                                        <th>" + getCasedName(field["field_name"]) +
                    "</th>";
        ...
        for (var r = 0; r < fieldData.length; r++) {
            ...
            if (r < (fieldData.length - 1)) {
                ...
                fieldSectionsDescription += sectionsData.length == 0 ? "" : sectionsData[field["field_section"]][
                    "description"
                ] + ",";
                key += field["key"] + ",";
