...
<div id="content" class="content">
    ...
    <h1 class="page-header">Purchases Update Form <small>purchases details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{!! route('purchases.update',$purchasesdata['data']->id) !!}" method="POST" class="form-horizontal">
<input type="hidden" name="_method" value="put" />
                        {!! csrf_field() !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="quantity" id="quantity" class="form-control" placeholder="Quantity" value="{!! $purchasesdata['data']->quantity !!}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Purchase Date" class="col-sm-3 control-label">Purchase Date</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="purchase_date" id="purchase_date" class="form-control" placeholder="Purchase Date" value="{!! $purchasesdata['data']->purchase_date !!}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Edit Purchases
                                        </button>
                                    </div>
                                </div>
                    </form>
...
$("#purchase_date").datepicker({todayHighlight:!0,autoclose:!0});
</script>
@endsection