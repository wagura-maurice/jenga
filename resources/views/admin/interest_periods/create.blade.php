...
<div id="content" class="content">
    ...
    <h1 class="page-header">Interest Periods Form <small>interest periods details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="button" onclick="save()" class="btn btn-sm btn-primary" id="btn-save">
                                            <i class="fa fa-btn fa-plus"></i> Add Interest Periods
                                        </button>
                                    </div>
                                </div>
                    </form>
...
function save(){
	...
	$.ajax({
		type:'POST',
		url: "{!! route('interestperiods.store')!!}",
		data:formData,
		cache:false,
		contentType: false,
		processData: false,
