                                ...
                                <table class="table table-profile">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($membershipfeesdata['clients'] as $clients)
                                        ...
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($membershipfeesdata['paymentmodes'] as $paymentmodes)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            {!! $membershipfeesdata['data']->transaction_number !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="field">Date</td>
                                            <td>
                                            {!! $membershipfeesdata['data']->date !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="field">Amount</td>
                                            <td>
                                            {!! $membershipfeesdata['data']->amount !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="field">Transaction Status</td>
                                            <td>				                                @foreach ($membershipfeesdata['transactionstatuses'] as $transactionstatuses)
