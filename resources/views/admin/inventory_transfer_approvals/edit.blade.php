...
<div id="content" class="content">
    ...
    <h1 class="page-header">Inventory Transfer Approvals Update Form <small>inventory transfer approvals details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{!! route('inventorytransferapprovals.update',$inventorytransferapprovalsdata['data']->id) !!}" method="POST" class="form-horizontal">
<input type="hidden" name="_method" value="put" />
                        {!! csrf_field() !!}
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="inventory_transfer" id="inventory_transfer">
                                            <option value="" >Select Inventory Transfer</option>				                                @foreach ($inventorytransferapprovalsdata['lgftoinventorytransfers'] as $lgftoinventorytransfers)
				                                ...
				                                <option selected value="{!! $lgftoinventorytransfers->id !!}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <Textarea name="remarks" id="remarks" class="form-control" row="20" placeholder="Remarks" value="{!! $inventorytransferapprovalsdata['data']->remarks !!}">{!! $inventorytransferapprovalsdata['data']->remarks !!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Edit Inventory Transfer Approvals
                                        </button>
                                    </div>
                                </div>
                    </form>
