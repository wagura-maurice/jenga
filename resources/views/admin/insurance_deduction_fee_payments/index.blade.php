...
<div id="content" class="content">
    ...
    <h1 class="page-header">Insurance Deduction Fee Payments  - DATA <small>insurance deduction fee payments  data goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
            @if($insurancedeductionfeepaymentsdata['usersaccountsroles'][0]->_add==1)
            <a href="{!! route('insurancedeductionfeepayments.create') !!}"><button type="button" class="btn btn-inverse btn-icon btn-circle m-b-10"><i class="fa fa-plus"></i></button></a>
            @endif
            @if($insurancedeductionfeepaymentsdata['usersaccountsroles'][0]->_report==1)
            <a href="{!! url('admin/insurancedeductionfeepaymentsreport') !!}"><button type="button" class="btn btn-inverse btn-icon btn-circle m-b-10"><i class="fa fa-file-text-o"></i></button></a>
            @endif
            @if($insurancedeductionfeepaymentsdata['usersaccountsroles'][0]->_report==1 || $insurancedeductionfeepaymentsdata['usersaccountsroles'][0]->_list==1)
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <form action="{!! route('insurancedeductionfeepayments.destroy',$insurancedeductionfeepayments->id) !!}" method="POST">
                                        ...
                                        <a href="{!! route('insurancedeductionfeepayments.show',$insurancedeductionfeepayments->id) !!}" id='show-insurancedeductionfeepayments-{!! $insurancedeductionfeepayments->id !!}' class='btn btn-sm btn-circle btn-inverse'>
                                            <i class='fa fa-btn fa-eye'></i>
                                        </a>
                                        @endif
                                        @if($insurancedeductionfeepaymentsdata['usersaccountsroles'][0]->_edit==1)
                                        <a href="{!! route('insurancedeductionfeepayments.edit',$insurancedeductionfeepayments->id) !!}" id='edit-insurancedeductionfeepayments-{!! $insurancedeductionfeepayments->id !!}' class='btn btn-sm btn-circle btn-warning'>
                                        ...
                                        {!! csrf_field() !!}
                                        {!! method_field('DELETE') !!}
                                        <button type='submit' id='delete-insurancedeductionfeepayments-{!! $insurancedeductionfeepayments->id !!}' class='btn btn-sm btn-circle btn-danger'>
                    ...
                    <form id="form"  class="form-horizontal" action="{!! url('admin/insurancedeductionfeepaymentsfilter') !!}" method="POST">
                        {!! csrf_field() !!}
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="loan__number"  id="loan__number">
                                            <option value="" >Select Loan  Number</option>				                                @foreach ($insurancedeductionfeepaymentsdata['loans'] as $loans)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="status"  id="status">
                                            <option value="" >Select Status</option>				                                @foreach ($insurancedeductionfeepaymentsdata['transactionstatuses'] as $transactionstatuses)
