...
<div id="content" class="content">
    ...
    <h1 class="page-header">Processing Fee Approvals Update Form <small>processing fee approvals details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{!! route('processingfeeapprovals.update',$processingfeeapprovalsdata['data']->id) !!}" method="POST" class="form-horizontal">
<input type="hidden" name="_method" value="put" />
                        {!! csrf_field() !!}
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="transaction_reference" id="transaction_reference">
                                            <option value="" >Select Transaction Reference</option>				                                @foreach ($processingfeeapprovalsdata['processingfeepayments'] as $processingfeepayments)
				                                @if( $processingfeepayments->id  ==  $processingfeeapprovalsdata['data']->transaction_reference  ){
				                                <option selected value="{!! $processingfeepayments->id !!}" >
								
				                                {!! $processingfeepayments->transaction_reference!!}
				                                </option>@else
				                                <option value="{!! $processingfeepayments->id !!}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="approval_level" id="approval_level">
                                            <option value="" >Select Approval Level</option>				                                @foreach ($processingfeeapprovalsdata['approvallevels'] as $approvallevels)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="approved_by" id="approved_by">
                                            <option value="" >Select Approved By</option>				                                @foreach ($processingfeeapprovalsdata['users'] as $users)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="approval_status" id="approval_status">
                                            <option value="" >Select Approval Status</option>				                                @foreach ($processingfeeapprovalsdata['transactionstatuses'] as $transactionstatuses)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="date" id="date" class="form-control" placeholder="Date" value="{!! $processingfeeapprovalsdata['data']->date !!}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Edit Processing Fee Approvals
                                        </button>
                                    </div>
                                </div>
                    </form>
