                    ...
                    <form id="form"  class="form-horizontal" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" onchange="getloanbalance()" data-style="btn-white" name="loan"  id="loan">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="button" disabled="" onclick="save()" class="btn btn-sm btn-primary" id="btn-save">
                                            <i class="fa fa-btn fa-plus"></i> Add Lgf To Loan Transfers
                                        </button>
                                    </div>
                                </div>
                    </form>
...
function save(){
	...
	$.ajax({
		type:'POST',
		url: "{!! route('lgftoloantransfers.store')!!}",
		data:formData,
		cache:false,
		contentType: false,
		processData: false,
...
function checkAmount(){
    ...
    if(!($amount>$loanbalance || $amount>$lgfbalance)){
...
$(document).ready(function(){
    ...
    function gettransactionnumber(){
        ...
        $.get("{!!url('/admin/getlgftoloantransactionnumber')!!}", function (data) {
