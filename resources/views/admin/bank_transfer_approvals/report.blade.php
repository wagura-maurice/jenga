...
<div id='content' class='content'>
            ...
            <h1 class="page-header hidden-print">Bank Transfer Approvals <small>bank transfer approvals report goes here...</small></h1>
            ...
            <div class="invoice">
                ...
                <div class="text-center" id="report-header" >
                    <table>
                        <tbody>
                            <tr>
                                <td></td><td><img src="{!!asset('uploads/images/'.$banktransferapprovalsdata['company'][0]->logo)!!}"   height='70px'/></td><td></td>
                            </tr>
                    <div class="invoice-date">
                            <tr>
                                <td></td><td class="text-center" style="font-size:18px; font-weight:bold; color:#000;">{!! $banktransferapprovalsdata['company'][0]->name!!}</td><td></td></tr>
                            <tr>
                                <td></td><td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">{!! $banktransferapprovalsdata['company'][0]->street!!} {!! $banktransferapprovalsdata['company'][0]->address!!}</td><td></td>
                                
                            </tr>
                            <tr>
                                <td></td><td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">{!! $banktransferapprovalsdata['company'][0]->city!!}, {!! $banktransferapprovalsdata['company'][0]->zip_code!!}</td><td></td>
                                
                            </tr>
                            <tr>
                                <td></td><td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">Phone: {!! $banktransferapprovalsdata['company'][0]->phone_number!!}</td><td></td>
