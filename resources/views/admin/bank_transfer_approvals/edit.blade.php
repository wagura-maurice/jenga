...
<div id="content" class="content">
    ...
    <h1 class="page-header">Bank Transfer Approvals Update Form <small>bank transfer approvals details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{!! route('banktransferapprovals.update',$banktransferapprovalsdata['data']->id) !!}" method="POST" class="form-horizontal">
<input type="hidden" name="_method" value="put" />
                        {!! csrf_field() !!}
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="bank_transfer" id="bank_transfer">
                                            <option value="" >Select Bank Transfer</option>				                                @foreach ($banktransferapprovalsdata['lgftobanktransfers'] as $lgftobanktransfers)
				                                ...
				                                <option selected value="{!! $lgftobanktransfers->id !!}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <Textarea name="remarks" id="remarks" class="form-control" row="20" placeholder="Remarks" value="{!! $banktransferapprovalsdata['data']->remarks !!}">{!! $banktransferapprovalsdata['data']->remarks !!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Edit Bank Transfer Approvals
                                        </button>
                                    </div>
                                </div>
                    </form>
