...
<div id="content" class="content">
    <ol class="breadcrumb pull-right">
        ...
        <li><a href="#">Trashes</a></li>
        <li class="active">form</li>
    </ol>
    <h1 class="page-header">Trashes Form <small>trashes details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="button" onclick="save()" class="btn btn-sm btn-primary" id="btn-save">
                                            <i class="fa fa-btn fa-plus"></i> Add Trashes
                                        </button>
                                    </div>
                                </div>
                    </form>
