...
@section('main_content')
    <div id="content" class="content">
        ...
        <h1 class="page-header">Expense Configurations Update Form <small>expense fee configurations details goes
                here...</small></h1>
        <div class="row">
            <div class="col-md-12">
                <a href="{!! route('expenseconfiguration.index') !!}"><button type="button"
            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form id="form" class="form-horizontal" action="{!! route('expenseconfiguration.update', $data['configuration']->id) !!}" method="POST">
                            {!! csrf_field() !!}
                            {!! method_field('PUT') !!}
                            <div class="form-group">
                                <label for="Expense Type" class="col-sm-3 control-label">Expense Type</label>
                                <div class="col-sm-6">
                                    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="expense_type" id="expense_type">
                                        <option value="">Select Expense Type</option>
                                        @foreach ($data['types'] as $type)
                                            <option value="{!! $type->id !!}" {{ $type->id == $data['configuration']->expensetypemodel->id ? 'selected' : NULL }}>
                                                {!! $type->name !!}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="payment_mode" id="payment_mode">
                                        ...
                                        @foreach ($data['paymentmodes'] as $paymentmodes)
                                            <option value="{!! $paymentmodes->id !!}" {{ $paymentmodes->id == $data['configuration']->paymentmodemodel->id ? 'selected' : NULL }}>
                                                {!! $paymentmodes->name !!}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="debit_account" id="debit_account">
                                        ...
                                        @foreach ($data['accounts'] as $accounts)
                                            <option value="{!! $accounts->id !!}" {{ $accounts->id == $data['configuration']->debitaccountmodel->id ? 'selected' : NULL }}>
                                                {!! $accounts->code !!}
                                                {!! $accounts->name !!}
                                            </option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="credit_account" id="credit_account">
                                        ...
                                        @foreach ($data['accounts'] as $accounts)
                                            <option value="{!! $accounts->id !!}" {{ $accounts->id == $data['configuration']->creditaccountmodel->id ? 'selected' : NULL }}>
                                                {!! $accounts->code !!}
                                                {!! $accounts->name !!}
                                            </option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-6">
                                    <button type="submit" class="btn btn-sm btn-primary">
                                        <i class="fa fa-btn fa-plus"></i> Update Expense Configurations
                                    </button>
                                </div>
                            </div>
                        </form>
