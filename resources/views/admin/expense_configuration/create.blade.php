...
@section('main_content')
    <div id="content" class="content">
        ...
        <h1 class="page-header">Expense Configurations Form <small>expense fee configurations details goes
                here...</small></h1>
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form id="form" class="form-horizontal" action="{!! route('expenseconfiguration.store') !!}" method="POST">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-6">
                                    <button type="submit" class="btn btn-sm btn-primary">
                                        <i class="fa fa-btn fa-plus"></i> Add Expense Configurations
                                    </button>
                                </div>
                            </div>
                        </form>
