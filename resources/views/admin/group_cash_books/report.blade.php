    ...
    <div id='content' class='content'>
        ...
        <div class="row no-print">
            <div class="col-md-12 hidden-print">
                <a href="{!! route('groupcashbooks.index') !!}"><button type="button"
        ...
        <div class="invoice">
            <div class="invoice-company">
                <span class="pull-right hidden-print">
                    <a href="{!! route('groupcashbooksreport.export', [
                        $groupcashbooksdata['id'],
                        $groupcashbooksdata['startDate'] ?? null,
                        $groupcashbooksdata['endDate'] ?? null,
                    ]) !!}" class="btn btn-sm btn-success m-b-10"><i
                            class="fa fa-download m-r-5"></i> Export as Excel</a>
            ...
            <div class="text-center" id="report-header">
                ...
                <table>
                    <tbody>
                        <tr>
                            <td></td>
                            <td><img src="{!! secure_asset('uploads/images/' . $groupcashbooksdata['company'][0]->logo) !!}" height='70px' /></td>
                            <td></td>
                        </tr>
                        <div class="invoice-date">
                            <tr>
                                ...
                                <td class="text-center" style="font-size:18px; font-weight:bold; color:#000;">
                                    {!! $groupcashbooksdata['company'][0]->name !!}</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">
                                    {!! $groupcashbooksdata['company'][0]->street !!} {!! $groupcashbooksdata['company'][0]->address !!}</td>
                                <td></td>
                            ...
                            <tr>
                                <td></td>
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">
                                    {!! $groupcashbooksdata['company'][0]->city !!}, {!! $groupcashbooksdata['company'][0]->zip_code !!}</td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">Phone:
                                    {!! $groupcashbooksdata['company'][0]->phone_number !!}</td>
                                <td></td>
                            </tr>
                    </tbody>
                </table>
                ...
                <table>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6 m-t-10">
                                        <input type="text" autocomplete="off" name="start_date" id="start_date"
                                            ...
                                            value="{{ \Carbon\Carbon::parse($groupcashbooksdata['startDate'])->format('d-m-Y') }}"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6 m-t-10">
                                        <input type="text" autocomplete="off" name="end_date" id="end_date"
                                            ...
                                            value="{{ \Carbon\Carbon::parse($groupcashbooksdata['endDate'])->format('d-m-Y') }}"
                                            required="required" data-date-format="dd-mm-yyyy"
                                            data-date-end-date="Date.default">
                                    </div>
                    ...
                    <tr>
                        <th style="padding:10px;">
                            <div class="row">
                                <div class="col-lg-12">
                                    <label for="transaction_date" class="control-label col-lg-6 m-t-10">Opening Balance :
                                        {!! number_format($groupcashbooksdata['opening-balance'], 2) !!}</label>
                                    <label for="transaction_date" class="control-label col-lg-6 m-t-10"></label>
                                </div>
                                <div class="col-lg-12">
                                    <label for="transaction_date" class="control-label col-lg-6 m-t-10">Debit :
                                        {!! number_format($groupcashbooksdata['working-debit'], 2) !!}</label>
                                    <label for="transaction_date" class="control-label col-lg-6 m-t-10"></label>
                                </div>
                            </div>
                        </th>
                        <th style="padding:10px;">
                            <div class="row">
                                <div class="col-lg-12">
                                    <label for="transaction_date" class="control-label col-lg-6 m-t-10">Closing Balance :
                                        {!! number_format($groupcashbooksdata['closing-balance'], 2) !!}</label>
                                    <label for="transaction_date" class="control-label col-lg-6 m-t-10"></label>
                                </div>
                                <div class="col-lg-12">
                                    <label for="transaction_date" class="control-label col-lg-6 m-t-10">Credit :
                                        {!! number_format($groupcashbooksdata['working-credit'], 2) !!}</label>
                                    <label for="transaction_date" class="control-label col-lg-6 m-t-10"></label>
                                </div>
                            </div>
                        </th>
                                ...
                                <tbody>
                                    @foreach ($groupcashbooksdata['list-b-view'] as $groupcashbooks)
                                        <tr>
                                            <td class='table-text'>
                                                <div>
                                                    {!! isset($groupcashbooks->transaction_date)
                                                        ? \Carbon\Carbon::parse($groupcashbooks->transaction_date)->format('d-m-Y')
                                                        : null !!}
                                                </div>
                                            </td>
                                            <td class='table-text'>
    ...
    <script language="javascript" type="text/javascript">
        $("#start_date").datepicker({
            ...
            if ($("#end_date").val() && $("#start_date").val()) {
                ...
                window.location.href = "{{ url('/admin/groupcashbooksreport/') }}/" + id + "/" + $("#start_date")
                    .val() + "/" + $("#end_date").val() + "";
            }
        });
        $("#end_date").datepicker({
