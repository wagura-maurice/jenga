        ...
        <div class="row">
            <div class="col-md-12">
                @if ($currenciesdata['usersaccountsroles'][0]->_add == 1)
                    <a href="{!! route('currencies.create') !!}"><button type="button"
                ...
                @if ($currenciesdata['usersaccountsroles'][0]->_report == 1)
                    <a href="{!! url('currenciesreport') !!}"><button type="button"
                                            ...
                                            <form action="{!! route('currencies.destroy', $currencies->id) !!}" method="POST">
                                                @if ($currenciesdata['usersaccountsroles'][0]->_show == 1)
                                                    <a href="{!! route('currencies.show', $currencies->id) !!}"
                                                        id='show-currencies-{!! $currencies->id !!}'
                                                ...
                                                @if ($currenciesdata['usersaccountsroles'][0]->_edit == 1)
                                                    <a href="{!! route('currencies.edit', $currencies->id) !!}"
                                                        id='edit-currencies-{!! $currencies->id !!}'
                                                ...
                                                @if ($currenciesdata['usersaccountsroles'][0]->_delete == 1)
                                                    ...
                                                    {!! csrf_field() !!}
                                                    {!! method_field('DELETE') !!}
                                                    <button type='submit' id='delete-currencies-{!! $currencies->id !!}'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal" action="{!! url('currenciesfilter') !!}"
                                        method="POST">
                                        {!! csrf_field() !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="abbreviation" id="abbreviation"
                                                    class="form-control" placeholder="Abbreviation" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
