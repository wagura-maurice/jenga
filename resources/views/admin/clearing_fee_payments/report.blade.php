...
<div id='content' class='content'>
            ...
            <h1 class="page-header hidden-print">Clearing Fee Payments <small>clearing fee payments report goes here...</small></h1>
            ...
            <div class="invoice">
                ...
                <div class="text-center" id="report-header" >
                    <table>
                        <tbody>
                            <tr>
                                <td></td><td><img src="{!!asset('uploads/images/'.$clearingfeepaymentsdata['company'][0]->logo)!!}"   height='70px'/></td><td></td>
                            </tr>
                    <div class="invoice-date">
                            <tr>
                                <td></td><td class="text-center" style="font-size:18px; font-weight:bold; color:#000;">{!! $clearingfeepaymentsdata['company'][0]->name!!}</td><td></td></tr>
                            <tr>
                                <td></td><td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">{!! $clearingfeepaymentsdata['company'][0]->street!!} {!! $clearingfeepaymentsdata['company'][0]->address!!}</td><td></td>
                                
                            </tr>
                            <tr>
                                <td></td><td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">{!! $clearingfeepaymentsdata['company'][0]->city!!}, {!! $clearingfeepaymentsdata['company'][0]->zip_code!!}</td><td></td>
                                
                            </tr>
                            <tr>
                                <td></td><td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">Phone: {!! $clearingfeepaymentsdata['company'][0]->phone_number!!}</td><td></td>
