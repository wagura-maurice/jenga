...
<div id="content" class="content">
    ...
    <h1 class="page-header">Mobile Money Transfer Configurations Update Form <small>mobile money transfer configurations details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{!! route('mobilemoneytransferconfigurations.update',$mobilemoneytransferconfigurationsdata['data']->id) !!}" method="POST" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Edit Mobile Money Transfer Configurations
                                        </button>
                                    </div>
                                </div>
                    </form>
