...
@section('main_content')
    ...
    <h1 class="page-header">Product Client Types Form <small>product client types details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                                ...
                                <table class="table table-profile">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($productclienttypesdata['loanproducts'] as $loanproducts)
                                        ...
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($productclienttypesdata['clienttypes'] as $clienttypes)
