                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="button" disabled="" onclick="save()" class="btn btn-sm btn-primary" id="btn-save">
                                            <i class="fa fa-btn fa-plus"></i> Add Lgf To Inventory Transfers
                                        </button>
                                    </div>
                                </div>
                    </form>
...
function save(){
	...
	$.ajax({
		type:'POST',
		url: "{!! route('lgftoinventorytransfers.store')!!}",
		data:formData,
		cache:false,
		contentType: false,
		processData: false,
...
$(document).ready(function(){
    ...
    function gettransactionnumber(){
        ...
        $.get("{!!url('/admin/getgftoinventorytransactionnumber')!!}", function (data) {
