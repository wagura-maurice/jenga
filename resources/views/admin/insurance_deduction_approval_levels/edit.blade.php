...
<div id="content" class="content">
    ...
    <h1 class="page-header">Insurance Deduction Approval Levels Update Form <small>insurance deduction approval levels details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{!! route('insurancedeductionapprovallevels.update',$insurancedeductionapprovallevelsdata['data']->id) !!}" method="POST" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Edit Insurance Deduction Approval Levels
                                        </button>
                                    </div>
                                </div>
                    </form>
