...
@section("main_content")
		<div id="content" class="content">
			...
			<h1 class="page-header">Mobile Money Transaction Charge Configurations Chart <small>mobile money transaction charge configurations chart goes here...</small></h1>
            <div class="row">
                <div class="col-md-12">
