...
<div id="content" class="content">
    ...
    <h1 class="page-header">Suspend Client<small>clients details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
    ...
    @if($clientsdata['suspended'][0]['id']!=$clientsdata['data']->id)
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="{{url('/admin/suspendclient/'.$clientsdata['data']->id)}}">
                        {!! csrf_field() !!}
                        <div class="row">
                            <div class="form-group">
                            ...
                            <div class="jumbotron m-b-0 text-center">
                                    <p>Please note. After submiting the client will be suspended.</p>
                                    <button class="btn-success btn-lg btn" type='submit' >Suspend</button>
                            </div>                                                    
                        </div>
