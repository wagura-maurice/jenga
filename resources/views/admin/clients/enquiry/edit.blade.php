            ...
            <div class="col-md-12">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form id="form" class="form-horizontal" action="{{ route('client.enquiry.catalog.update', $data['enquiry']->id) }}" method="POST">
                            {!! csrf_field() !!}
                            {{ method_field('PATCH') }}
                                    ...
                                    <select class="form-control selectpicker" data-size="100000" data-live-search="true"
                                        ...
                                        @foreach ($data['categories'] as $category)
                                            <option value="{!! $category->id !!}"
                                                {{ $data['enquiry']->category_id == $category->id ? 'selected' : null }}>
                                                {!! $category->name !!}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control selectpicker" data-size="100000" data-live-search="true"
                                        ...
                                        @foreach ($data['clients'] as $client)
                                            <option value="{!! $client->id !!}"
                                                {{ $data['enquiry']->client_id == $client->id ? 'selected' : null }}>
                                                {!! $client->first_name !!}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date" id="customer_name">
                                        <input type="text" class="form-control" name="customer_name"
                                            value="{{ $data['enquiry']->customer_name }}" />
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date" id="customer_email">
                                        <input type="email" class="form-control" name="customer_email"
                                            value="{{ $data['enquiry']->customer_email }}" />
                                        <span class="input-group-addon">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date" id="customer_phone_number">
                                        <input type="tel" class="form-control" name="customer_phone_number"
                                            value="{{ $data['enquiry']->customer_phone_number }}" />
                                        <span class="input-group-addon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date">
                                        <input type="text" class="form-control" name="occurrence_date" id="occurrence_date" value="{{ $data['enquiry']->occurrence_date }}"/>
                                        <span class="input-group-addon">
                                    ...
                                    <select class="form-control selectpicker" data-size="100000" data-live-search="true"
                                        ...
                                        @foreach ($data['users'] as $user)
                                            <option value="{!! $user->id !!}"
                                                {{ $data['enquiry']->escalated_to == $user->id ? 'selected' : null }}>
                                                {!! $user->name !!}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control selectpicker" data-size="100000" data-live-search="true"
                                        ...
                                        @foreach ($data['branches'] as $branch)
                                            <option value="{!! $branch->id !!}"
                                                {{ $data['enquiry']->branch == $branch->id ? 'selected' : null }}>
                                                {!! ucwords($branch->name) !!}
                                            </option>
                                        @endforeach
                                    </select>
