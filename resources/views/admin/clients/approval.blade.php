                ...
                <div class="panel-body">
                    <form action="{!! route('clients.update',$clientsdata['data']->id) !!}" method="POST" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Client Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->client_number !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Name" class="col-sm-3 control-label">Name</label>
                                    <div class="col-sm-6">
                                        <label for="Name" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->first_name !!} {!! $clientsdata['data']->middle_name !!} {!! $clientsdata['data']->last_name !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Id Number" class="col-sm-3 control-label">Id Number</label>
                                    <div class="col-sm-6">
                                        <label for="Id Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->id_number !!}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Primary Phone Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->primary_phone_number !!}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Secondary Phone Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->secondary_phone_number !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Salutation" class="col-sm-6 control-label text-left">@foreach ($clientsdata['salutations'] as $salutations){!! $salutations->abbreviation!!}@endforeach</label>
                                    </div>
                                </div>                                                                
                                <div class="form-group">
                                    <label for="Date Of Birth" class="col-sm-3 control-label">Date Of Birth</label>
                                    <div class="col-sm-6">
                                        <label for="Date Of Birth" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->date_of_birth !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Postal Address" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->postal_address !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Postal Code" class="col-sm-3 control-label">Postal Code</label>
                                    <div class="col-sm-6">
                                        <label for="Postal Code" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->postal_code !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Postal Town" class="col-sm-3 control-label">Postal Town</label>
                                    <div class="col-sm-6">
                                        <label for="Postal Town" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->postal_town !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Email Address" class="col-sm-3 control-label">Email Address</label>
                                    <div class="col-sm-6">
                                        <label for="Email Address" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->email_address !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Location" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->location !!}</label>                                                                                                                     
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Village" class="col-sm-3 control-label">Village</label>
                                    <div class="col-sm-6">
                                        <label for="Village" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->village !!}</label>                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Nearest Center" class="col-sm-3 control-label">Nearest Center</label>
                                    <div class="col-sm-6">
                                        <label for="Nearest Center" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->nearest_center !!}</label>                                                               
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Home GPS Latitude" class="col-sm-3 control-label">Home GPS Latitude</label>
                                    <div class="col-sm-6">
                                        <label for="Home GPS Latitude" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->home_gps_latitude !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Home GPS Longitude" class="col-sm-3 control-label">Home GPS Longitude</label>
                                    <div class="col-sm-6">
                                        <label for="Home GPS Longitude" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->home_gps_longitude !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Business GPS Latitude" class="col-sm-3 control-label">Business GPS Latitude</label>
                                    <div class="col-sm-6">
                                        <label for="Business GPS Latitude" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->business_gps_latitude !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Business GPS Longitude" class="col-sm-3 control-label">Business GPS Longitude</label>
                                    <div class="col-sm-6">
                                        <label for="Business GPS Longitude" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->business_gps_longitude !!}</label>
                                    </div>
                                </div>
                                            </div>
                                        </fieldset>
									...
									<div>
                                        <fieldset>
                                            ...
                                            <div class="row">
                                <div class="form-group">
                                    <label for="Spouse First Name" class="col-sm-3 control-label">Spouse Name</label>
                                    <div class="col-sm-6">
                                        <label for="Spouse Name" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->spouse_first_name !!} {!! $clientsdata['data']->spouse_middle_name !!} {!! $clientsdata['data']->spouse_last_name !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Spouse Id Number" class="col-sm-3 control-label">Spouse Id Number</label>
                                    <div class="col-sm-6">
                                        <label for="Spouse Id Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->spouse_id_number !!}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Spouse Primary Phone Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->spouse_primary_phone_number !!}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Spouse Secondary Phone Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->spouse_secondary_phone_number !!}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Spouse Email Address" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->spouse_email_address !!}</label>
									...
									<div>
                                        <fieldset>
                                            ...
                                            <div class="row">
                                <div class="form-group">
                                    <label for="Next Of Kin First Name" class="col-sm-3 control-label">Next Of Kin Name</label>
                                    <div class="col-sm-6">
                                        <label for="Next Of Kin Name" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->next_of_kin_first_name !!} {!! $clientsdata['data']->next_of_kin_middle_name !!} {!! $clientsdata['data']->next_of_kin_last_name !!}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Relationship With Next Of Kin" class="col-sm-3 control-label">Relationship With Next Of Kin</label>
                                    <div class="col-sm-6">
                                        <label for="Relationship With Next Of Kin" class="col-sm-6 control-label text-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Next Of Kin Primary Phone Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->next_of_kin_primary_phone_number !!}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Next Of Kin Secondary Phone Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->next_of_kin_primary_phone_number !!}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Next Of Kin Email Address" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->next_of_kin_email_address !!}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Next Of Kin County" class="col-sm-6 control-label text-left">
                                            @foreach ($clientsdata['counties'] as $counties)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Next Of Kin Sub County" class="col-sm-6 control-label text-left">@foreach ($clientsdata['subcounties'] as $subcounties)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Next Of Kin Location" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->next_of_kin_location !!}</label>                                        
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Main Economic Activity" class="col-sm-6 control-label text-left">@foreach ($clientsdata['maineconomicactivities'] as $maineconomicactivities)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="Secondary Economic Activity" class="col-sm-6 control-label text-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->client_finger_print}}')" alt="client finger print photo"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Client Signature" class="col-sm-3 control-label">Client Signature</label>
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->client_signature}}')" alt="client signature photo"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Client Photo" class="col-sm-3 control-label">Home Image 1</label>
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->home_image_1}}')" alt="home image 1"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Client Finger Print" class="col-sm-3 control-label">Home Image 2</label>
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->home_image_2}}')" alt="home image 2"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Client Signature" class="col-sm-3 control-label">Home Image 3</label>
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->home_image_3}}')" alt="home image 3"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Client Photo" class="col-sm-3 control-label">Business Image 1</label>
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->business_image_1}}')" alt="business image 1"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Client Finger Print" class="col-sm-3 control-label">Business Image 2</label>
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->business_image_2}}')" alt="business image 2"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Client Signature" class="col-sm-3 control-label">Business Image 3</label>
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->business_image_3}}')" alt="business image 3"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Comments" class="col-sm-3 control-label">Comments</label>
                                    <div class="col-sm-6">
                                        <label for="Client Number" class="col-sm-6 control-label text-left">{!! $clientsdata['data']->comments !!}</label>                                        
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="{{url('/admin/approveclient/'.$clientsdata['data']->id)}}">
                        {!! csrf_field() !!}
                        <div class="row">
                            <div class="form-group">
                                <label for="Client Category" class="col-sm-3 control-label text-right">Make Client</label>
                                <div class="col-sm-6">
                                    <label for="Client Number" class="col-sm-6 control-label text-left">@foreach ($clientsdata['clientcategories'] as $clientcategories)
                            ...
                            <div class="form-group">
                                <label for="Client Category" class="col-sm-3 control-label text-right">Expected Membership Fees</label>
                                <div class="col-sm-6">
                                    <label for="Client Number" class="col-sm-6 control-label text-left">
                                        @if(isset($clientsdata["clienttypemembershipfees"][0])){{$clientsdata["clienttypemembershipfees"][0]['fee']}}@endif
                                    </label>

                                </div>
                            </div>                             
                            <div class="form-group">
                                <label for="Client Category" class="col-sm-3 control-label text-right">Paid Membership Fees</label>
                                <div class="col-sm-6">
                                    <label for="Client Number" class="col-sm-6 control-label text-left">
                            ...
                            <div class="form-group">
                                <label for="Client Category" class="col-sm-3 control-label text-right">Comments</label>
                                <div class="col-sm-6">
                            ...
                            <div class="jumbotron m-b-0 text-center">
                                    ...
                                    @if(isset($clientsdata["clienttypemembershipfees"][0]))
                                        @if($clientsdata["clienttypemembershipfees"][0]['fee']==$clientsdata['membershipfees'] && $clientsdata['membershipfees']>0)
                                        <p>Please note. After submiting the client will be approved.</p>
                                        <button class="btn-success btn-lg btn" type='submit' id="btn-save" >Approve</button>
                                        @else
