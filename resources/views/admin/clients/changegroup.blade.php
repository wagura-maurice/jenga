...
@section('main_content')
    <div id="content" class="content">
        ...
        <h1 class="page-header">Change Group Request <small>clients details goes here...</small></h1>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="post"
                                action="{{ url('/admin/changeclientgroup/' . $clientsdata['data']->id) }}">
                                {!! csrf_field() !!}
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="Client_group" class="col-sm-3 control-label">Current Group</label>
                                        <div class="col-sm-6">
                                            <label for="Client Number" class="col-sm-6 control-label text-left">
                                                @if (isset($clientsdata['clientgroup']))
                                                    {{ $clientsdata['clientgroup']->group_number }}
                                                    {{ $clientsdata['clientgroup']->group_name }}
                                                @else
                                                    Client Has No group
                                                @endif
                                            </label>
                                    ...
                                    <div class="form-group">
                                        <label for="Client_group" class="col-sm-3 control-label">New Group</label>
                                        <div class="col-sm-6">
                                            <select class="form-control" name="new_group" id="new_group">
                                                <option value="">Select Client_group</option>
                                                @foreach ($clientsdata['groups'] as $groups)
                                    ...
                                    <div class="jumbotron m-b-0 text-center">
                                        ...
                                        @if (isset($clientsdata['clienttypemembershipfees'][0]))
                                            @if (
                                                ...
                                                @if (isset($clientsdata['pendingchangegrouprequest'][0]))
                                                    <p>There is aalready a pending request!!</p>
                                                @else
                                                    <p>Please note. After submiting, the request to transfer client to the
                                                        selected group will be made.</p>
                                                    <button class="btn-success btn-lg btn" type='submit'
                                                        id="btn-save">Submit Request</button>
                                                @endif
                                            @else
