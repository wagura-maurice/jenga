...
<div id="content" class="content">
    ...
    <h1 class="page-header">Black List Client <small>clients details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    <form action="{!! route('clients.update',$clientsdata['data']->id) !!}" method="POST" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->client_finger_print}}')" alt="client photo"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Client Signature" class="col-sm-3 control-label">Client Signature</label>
                                    <div class="col-sm-6">
                                        <img src="asset('/uploads/images/{{$clientsdata['data']->client_signature}}')" alt="client photo"/>
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    @if($clientsdata['blacklisted'][0]['id']!=$clientsdata['data']->client_category)
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="{{url('/admin/blacklistclient/'.$clientsdata['data']->id)}}">
                        {!! csrf_field() !!}
                        <div class="row">
                            <div class="form-group">
                            ...
                            <div class="jumbotron m-b-0 text-center">
                                    <p>Please note. After submiting the client will be blacklisted.</p>
                                    <button class="btn-success btn-lg btn" type='submit' >BlackList</button>
                            </div>                                                    
                        </div>
