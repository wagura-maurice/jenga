...
@section('main_content')
    ...
    <h1 class="page-header">Bank Transfer Charge Configurations Form <small>bank transfer charge configurations details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="profile-info">
                            <div class="table-responsive">
                                <table class="table table-profile">
                                    <thead>
                                    	<tr class="highlight">
                                    		<td>Bank Transfer Charge Configurations</td>
                                    		<td>Profile Data</td>
                                    	</tr>
                                        <tr class="divider">
                                            <td colspan="2"></td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($banktransferchargeconfigurationsdata['clienttypes'] as $clienttypes)
                                        ...
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($banktransferchargeconfigurationsdata['accounts'] as $accounts)
