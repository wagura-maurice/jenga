            ...
            <div class="text-center" id="report-header">
                <table>
                    <tbody>
                        <tr>
                            <td></td>
                            <td><img src="{!! secure_asset('uploads/images/' . $salesordersdata['company'][0]->logo) !!}" height='70px' /></td>
                            <td></td>
                        </tr>
                        <div class="invoice-date">
                            <tr>
                                ...
                                <td class="text-center" style="font-size:18px; font-weight:bold; color:#000;">
                                    {!! $salesordersdata['company'][0]->name !!}</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">
                                    {!! $salesordersdata['company'][0]->street !!} {!! $salesordersdata['company'][0]->address !!}</td>
                                <td></td>
                            ...
                            <tr>
                                <td></td>
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">
                                    {!! $salesordersdata['company'][0]->city !!}, {!! $salesordersdata['company'][0]->zip_code !!}</td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">Phone:
                                    {!! $salesordersdata['company'][0]->phone_number !!}</td>
                                <td></td>
