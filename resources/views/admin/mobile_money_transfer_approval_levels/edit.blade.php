...
<div id="content" class="content">
    ...
    <h1 class="page-header">Mobile Money Transfer Approval Levels Update Form <small>mobile money transfer approval levels details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{!! route('mobilemoneytransferapprovallevels.update',$mobilemoneytransferapprovallevelsdata['data']->id) !!}" method="POST" class="form-horizontal">
<input type="hidden" name="_method" value="put" />
                        {!! csrf_field() !!}
                                <div class="form-group">
                                    <label for="Client Types" class="col-sm-3 control-label">Client Type</label>
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="client_type" id="client_type">
                                            <option value="" >Select Client Type</option>				                                @foreach ($mobilemoneytransferapprovallevelsdata['clienttypes'] as $clienttypes)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Edit Mobile Money Transfer Approval Levels
                                        </button>
                                    </div>
                                </div>
                    </form>
