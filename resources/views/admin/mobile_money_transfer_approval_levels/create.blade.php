                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="client_type"  id="client_type">
                                            ...
                                            @foreach ($mobilemoneytransferapprovallevelsdata['clienttypes'] as $clienttypes)
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="button" onclick="save()" class="btn btn-sm btn-primary" id="btn-save">
                                            <i class="fa fa-btn fa-plus"></i> Add Mobile Money Transfer Approval Levels
                                        </button>
                                    </div>
                                </div>
                    </form>
...
function save(){
	...
	$.ajax({
		type:'POST',
		url: "{!! route('mobilemoneytransferapprovallevels.store')!!}",
		data:formData,
		cache:false,
		contentType: false,
		processData: false,
