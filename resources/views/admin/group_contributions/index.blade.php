...
<div id="content" class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{!! route('groups.create') !!}"><button type="button" class="btn btn-inverse btn-icon btn-circle m-b-10"><i class="fa fa-plus"></i></button></a>
            @endif
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <form action="{!! route('groups.destroy',$groups->id) !!}" method="POST">
                                        ...
                                        <a href="{!! route('groupcontributions.edit',$groups->id) !!}" id='edit-groups-{!! $groups->id !!}' class='btn btn-sm btn-circle btn-primary'>
...
$("#registration_datefrom").datepicker({todayHighlight:!0,autoclose:!0});
$("#registration_dateto").datepicker({todayHighlight:!0,autoclose:!0});
</script>
<script language="javascript" type="text/javascript">
$("#group_formation_datefrom").datepicker({todayHighlight:!0,autoclose:!0});
$("#group_formation_dateto").datepicker({todayHighlight:!0,autoclose:!0});
</script>
@endsection