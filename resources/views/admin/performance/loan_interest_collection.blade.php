...
@section('main_content')
    <div id="content" class="content">
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Loan Interest</li>
        </ol>
        <h1 class="page-header">Loan Interest Performance - DATA <small>report listings data goes here...</small></h1>
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('performance.interest.collection.download') }}" method="POST" id="downloadForm"
                            ...
                            <tbody>
                                @foreach ($data['list'] as $interest)
                                    <tr>
                                        ...
                                        <td class='table-text'>
                                            <div>
                                                {!! $interest->paymentMode->code . ' - ' . $interest->paymentMode->name !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal" action="{!! route('performance.interest.collection') !!}"
                                        method="GET">
                                        <!-- Branch dropdown -->
