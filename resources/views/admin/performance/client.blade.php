...
@section('main_content')
    <div id="content" class="content">
        ...
        <h1 class="page-header">Clients Performance - DATA <small>report listings data goes here...</small></h1>
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('performance.client.download') }}" method="POST" id="downloadForm"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal" action="{!! route('performance.client') !!}"
                                        method="GET">
                                        <!-- Branch dropdown -->
