...
@section('main_content')
    <div id="content" class="content">
        ...
        <h1 class="page-header">Disbursements Performance - DATA <small>report listings data goes here...</small></h1>
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('performance.disbursement.download') }}" method="POST" id="downloadForm"
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($data['list'] as $disbarment)
                                    <tr>
                                        <td class='table-text'>
                                            <div class="label label-info">
                                                # {!! $disbarment->loanmodel->loan_number !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! ucwords(
                                                    $disbarment->loanmodel->clientmodel->first_name .
                                                        ' ' .
                                                        $disbarment->loanmodel->clientmodel->middle_name .
                                                        ' ' .
                                                        $disbarment->loanmodel->clientmodel->last_name,
                                                ) !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $disbarment->loanmodel->date !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $disbarment->loanmodel->total_loan_amount !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $disbarment->loanmodel->amount_to_be_disbursed !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $disbarment->disbursement_status == 1
                                                    ? 'Pending'
                                                    : ($disbarment->disbursement_status == 2
                                                        ? 'Disbursed'
                                                        : ($disbarment->disbursement_status == 3
                                                            ? 'Rejected'
                                                            : '')) !!}
                                            </div>
                                        </td>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal" action="{!! route('performance.disbursement') !!}"
                                        method="GET">
                                        <!-- Branch dropdown -->
