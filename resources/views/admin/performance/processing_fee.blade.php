...
@section('main_content')
    <div id="content" class="content">
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Processing Fees</li>
        </ol>
        <h1 class="page-header">Processing Fees Performance - DATA <small>report listings data goes here...</small></h1>
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('performance.processing.fee.download') }}" method="POST" id="downloadForm"
                                    ...
                                    <tr>
                                        <td class='table-text'>
                                            <div class="label label-info">
                                                # {!! $fee->loannumbermodel->loan_number !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! ucwords(
                                                    $fee->loannumbermodel->clientmodel->first_name .
                                                        ' ' .
                                                        $fee->loannumbermodel->clientmodel->middle_name .
                                                        ' ' .
                                                        $fee->loannumbermodel->clientmodel->last_name,
                                                ) !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $fee->loannumbermodel->date !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $fee->loannumbermodel->total_loan_amount !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $fee->loannumbermodel->amount_to_be_disbursed !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                        ...
                                        <td class='table-text'>
                                            <div>
                                                {!! $fee->paymentmodemodel->code . ' - ' . $fee->paymentmodemodel->name !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $fee->transaction_number !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $fee->transaction_status == 1
                                                    ? 'Pending'
                                                    : ($fee->transaction_status == 2
                                                        ? 'Approved'
                                                        : ($fee->transaction_status == 3
                                                            ? 'Rejected'
                                                            : '')) !!}
                                            </div>
                                        </td>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal" action="{!! route('performance.processing.fee') !!}"
                                        method="GET">
                                        <!-- Branch dropdown -->
