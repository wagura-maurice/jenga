...
@section('main_content')
    <div id="content" class="content">
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Loan collections</li>
        </ol>
        <h1 class="page-header">Loan Collection Performance - DATA <small>report listings data goes here...</small></h1>
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('performance.loan.collection.download') }}" method="POST" id="downloadForm"
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($data['list'] as $payment)
                                    <tr>
                                        <td class='table-text'>
                                            <div class="label label-info">
                                                # {!! $payment->loanmodel->loan_number !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! ucwords(
                                                    $payment->loanmodel->clientmodel->first_name .
                                                        ' ' .
                                                        $payment->loanmodel->clientmodel->middle_name .
                                                        ' ' .
                                                        $payment->loanmodel->clientmodel->last_name,
                                                ) !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $payment->loanmodel->date !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $payment->loanmodel->total_loan_amount !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                                {!! $payment->loanmodel->amount_to_be_disbursed !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                        ...
                                        <td class='table-text'>
                                            <div>
                                                {!! $payment->modeofpaymentmodel->code . ' - ' .  $payment->modeofpaymentmodel->name !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal" action="{!! route('performance.loan.collection') !!}"
                                        method="GET">
                                        <!-- Branch dropdown -->
