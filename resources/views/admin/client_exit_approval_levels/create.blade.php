...
<div id="content" class="content">
    ...
    <h1 class="page-header">Client Exit Approval Levels Form <small>client exit approval levels details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="button" onclick="save()" class="btn btn-sm btn-primary" id="btn-save">
                                            <i class="fa fa-btn fa-plus"></i> Add Client Exit Approval Levels
                                        </button>
                                    </div>
                                </div>
                    </form>
...
function save(){
	...
	$.ajax({
		type:'POST',
		url: "{!! route('clientexitapprovallevels.store')!!}",
		data:formData,
		cache:false,
		contentType: false,
		processData: false,
