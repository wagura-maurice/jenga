        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @if ($groupsdata['usersaccountsroles'][0]->_report == 1)
                    <a href="{!! url('admin/groupsreport') !!}"><button type="button"
                        ...
                        <table id="data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @foreach ($groupsdata['list'] as $groups)
                                    <tr class='{{ isset($groups->deleted_at) ? 'danger' : '' }}'>
                                        <td class='table-text'>
                                            <div>
                                                {!! $groups->group_number !!}
                                            </div>
                                        ...
                                        <td class='table-text'>
                                            <div>
                                                {!! $groups->meeting_time ? $groups->meeting_time : '' !!}
                                            </div>
                                        </td>
                                        <td class='table-text'>
                                            <div>
                                        ...
                                        <td>
                                            @if ($groupsdata['usersaccountsroles'][0]->_show == 1)
                                                @if (!isset($groups->deleted_at))
                                                    <a href="{!! route('groups.show', $groups->id) !!}"
                                                        id='show-groups-{!! $groups->id !!}'
                                            ...
                                            @if ($groupsdata['usersaccountsroles'][0]->_edit == 1)
                                                <a href="{!! route('groups.edit', $groups->id) !!}" id='edit-groups-{!! $groups->id !!}'
                                                    class='btn btn-sm btn-circle btn-warning'>
                                                    <i class='fa fa-btn fa-edit'></i>
                                                </a>
                                            @endif
                                            @if ($groupsdata['usersaccountsroles'][0]->_edit == 1)
                                                <a href="{!! route('groupcontributions.edit', $groups->id) !!}" id='edit-groups-{!! $groups->id !!}'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal" action="{!! url('admin/groupsfilter') !!}"
                                        method="POST">
                                        {!! csrf_field() !!}
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="group_number" id="group_number"
                                                    class="form-control" placeholder="Group Number" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="group_name" id="group_name"
                                                    class="form-control" placeholder="Group Name" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="meeting_time" id="meeting_time"
                                                    class="form-control" placeholder="Meeting Time" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="Meeting Frequency" class="col-sm-3 control-label">Meeting
                                                Frequency</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="Preferred Mode Of Banking"
                                                class="col-sm-3 control-label">Preferred
                                                Mode Of Banking</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="Registration Date" class="col-sm-3 control-label">Registration
                                                Date</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="registration_datefrom"
                                                    id="registration_datefrom" class="form-control m-b-5"
                                                    placeholder="Registration Date From" value="">
                                                <input type="text" name="registration_dateto" id="registration_dateto"
                                                    class="form-control" placeholder="Registration Date To"
                                                    value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="Group Formation Date" class="col-sm-3 control-label">Group
                                                Formation Date</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="group_formation_datefrom"
                                                    id="group_formation_datefrom" class="form-control m-b-5"
                                                    placeholder="Group Formation Date From" value="">
                                                <input type="text" name="group_formation_dateto"
                                                    id="group_formation_dateto" class="form-control"
                                                    placeholder="Group Formation Date To" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
...
@section('script')
    <script language="javascript" type="text/javascript">
        function destroy(id, action) {
            // console.log(id);
            Swal.fire({
                title: 'Provide a reason to ' + action + ' this group.',
                input: 'textarea',
