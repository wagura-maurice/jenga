...
<div id="content" class="content">
    ...
    <h1 class="page-header">Bank Transfer Configurations Form <small>bank transfer configurations details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="button" onclick="save()" class="btn btn-sm btn-primary" id="btn-save">
                                            <i class="fa fa-btn fa-plus"></i> Add Bank Transfer Configurations
                                        </button>
                                    </div>
                                </div>
                    </form>
...
function save(){
	...
	$.ajax({
		type:'POST',
		url: "{!! route('banktransferconfigurations.store')!!}",
		data:formData,
		cache:false,
		contentType: false,
		processData: false,
