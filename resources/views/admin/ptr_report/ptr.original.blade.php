                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered" id="contribution-tbl">
                            <thead>
                                <tr>
                                    <th rowspan="2">CID</th>
                                    <th rowspan="2" nowrap>CLIENT NAME</th>
                                    <th nowrap>Loan No</th>
                                    <th rowspan="2">Amount</th>
                                    <th rowspan="2">Exp Pay</th>
                                    <th>Last Pay Day</th>
                                    <th>Arr/Pr Period</th>
                                    <th rowspan="2">Next Pay Date</th>
                                    <th rowspan="2">OLB</th>
                                    <th>Last LGF Date</th>
                            ...
                            <tbody>
                                ...
                                <tr id="<?php ++$r;
                                        echo $r; ?>">
                                    <td rowspan="2"><input type="hidden" name="client[]" value="{{$clientcontribution['client']['id']}}" />{!! $clientcontribution['client']['client_number'] !!}</td>
                                    <td rowspan="2"> {!! $clientcontribution['client']['first_name'] !!} {!! $clientcontribution['client']['middle_name'] !!} {!! $clientcontribution['client']['last_name'] !!}</td>
                                    <td>{!!$loan->loan_number!!}</td>
                                    <td rowspan="2">{!!$loan->amount!!}</td>
                                    <td rowspan="2">{!!$loan->exppay!!}</td>
                                    <td>{!!$loan->lastpaydate!!}</td>
                                    @if($loan->arrears<0)
                                     <td><span class="label label-warning">{!!$loan->arrears_period!!}</span></td>
                                        @else
                                        <td>{!!$loan->arrears_period!!}</td>
                                        @endif
                                        @if($loan->arrears<0) <td rowspan="2"><span class="label label-warning">{!!$loan->nextpay!!}</span></td>
                                            @else
                                            <td rowspan="2">{!!$loan->nextpay!!}</td>
                                            @endif

                                            <td rowspan="2">{!!$loan->rembalance!!}</td>
                                            <td>@if(isset($clientcontribution['lgf']['lastcontributiondate'])){!!$clientcontribution['lgf']['lastcontributiondate']!!}@endif</td>
                                            <td rowspan="2">@if(isset($clientcontribution['lgf']['lastcontributiondate'])){!!$clientcontribution['lgf']['totallgfcontribution']!!}@endif</td>
                                </tr>
                                <tr id="<?php ++$r;
                                        echo $r; ?>">
                                    <td>{!!date('d-m-Y', strtotime($loan->date));!!}</td>
                                    <td>{!!$loan->lastpayamount!!}</td>
                                    @if($loan->arrears<0) <td><span class="label label-warning">{!!$loan->arrears!!}</span></td>
                                        @else
                                        <td>{!!$loan->arrears!!}</td>
                                        @endif
                                        <td>@if(isset($clientcontribution['lgf']['lastcontributiondate'])){!!$clientcontribution['lgf']['lastcontribution']!!}@endif</td>
                                </tr>
                                @endif
                                @else
                                <tr id="<?php ++$r;
                                    ...
                                    <td rowspan="2">{!!$loan->exppay!!}</td>
                                    <td>{!!$loan->lastpaydate!!}</td>
                                    @if($loan->arrears<0) <td><span class="label label-warning">{!!$loan->arrears_period!!}</span></td>
                                        @else
                                        <td>{!!$loan->arrears_period!!}</td>
                                        @endif
                                ...
                                <tr id="<?php ++$r;
                                        echo $r; ?>">
                                    <td rowspan="2">{!! $clientcontribution['client']['client_number'] !!}</td>
                                    <td rowspan="2"> {!! $clientcontribution['client']['first_name'] !!} {!! $clientcontribution['client']['middle_name'] !!} {!! $clientcontribution['client']['last_name'] !!}</td>
                                    <td></td>
                                    <td rowspan="2"></td>
                                    <td rowspan="2"></td>
                        ...
                        <span class="label label-inverse f-w-200 f-s-20">Grand Total : KSH. {!! number_format($groupsdata["grandtotal"], 2, '.', ',')!!}</span>
