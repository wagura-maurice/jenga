...
@section('main_content')
    ...
    @endforeach
                        ...
                        <div class="panel-toolbar hidden-print">
                            <div class="btn-group pull-right m-t-5 m-r-10">
                                <a href="{{ route('ptrreport.export', $groupsdata['data']->id) }}"
                                    class="btn btn-sm btn-primary m-r-5">
                                    <i class="fa fa-download m-r-5"></i> Download
                                </a>
                                <a href="javascript:;" onclick="window.print()" class="btn btn-sm btn-info">
                                                        ...
                                                        echo $r; ?>">
                                                            ...
                                                            <td>
                                                                @if (isset($clientcontribution['lgf']['lastcontributiondate']))
                                                                    {!! \Carbon\Carbon::parse($clientcontribution['lgf']['lastcontributiondate'])->diffForHumans() !!}
                                                                @endif
                                                            </td>
                                                            <td>
                                                                @if (isset($clientcontribution['lgf']['lastcontributiondate']))
                                                                    {!! number_format($clientcontribution['lgf']['lastcontribution']) !!}
                                                                @endif
                                                            </td>
                                                            <td>
                                                                @if (isset($clientcontribution['lgf']['lastcontributiondate']))
                                                                    {!! number_format($clientcontribution['lgf']['totallgfcontribution']) !!}
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    @endif
...
@section('script')
    <script language="javascript" type="text/javascript">
        ...
        function addOtherPayment(currentRow, client) {
            ...
            var row = $("<tr id='" + lastAddedRow + "'><td><input type=\"hidden\" name=\"client[]\" value=\"" + client +
                ...
                lastAddedRow + "','" + client +
                "')\"><i class=\"fa fa-minus\"></i></button><button type=\"button\" name=\"add-other-payment\" class=\"add-other-payment btn-primary\"  onclick=\"addOtherPayment('" +
                lastAddedRow + "','" + client + "')\"><i class=\"fa fa-plus\"></i></button></td></tr> ");
