        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @if ($countriesdata['usersaccountsroles'][0]->_report == 1)
                    <a href="{!! url('countriesreport') !!}"><button type="button"
                                        ...
                                        <td>
                                            <form action="{!! route('countries.destroy', $countries->id) !!}" method="POST">
                                                @if ($countriesdata['usersaccountsroles'][0]->_show == 1)
                                                    <a href="{!! route('countries.show', $countries->id) !!}"
                                                        id='show-countries-{!! $countries->id !!}'
                                                ...
                                                @if ($countriesdata['usersaccountsroles'][0]->_edit == 1)
                                                    <a href="{!! route('countries.edit', $countries->id) !!}"
                                                        id='edit-countries-{!! $countries->id !!}'
                                                ...
                                                @if ($countriesdata['usersaccountsroles'][0]->_delete == 1)
                                                    ...
                                                    {!! csrf_field() !!}
                                                    {!! method_field('DELETE') !!}
                                                    <button type='submit' id='delete-countries-{!! $countries->id !!}'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal" action="{!! url('countriesfilter') !!}"
                                        method="POST">
                                        {!! csrf_field() !!}
