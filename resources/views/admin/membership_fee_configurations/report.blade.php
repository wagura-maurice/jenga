...
@section('main_content')
    <div id='content' class='content'>
        ...
        <h1 class="page-header hidden-print">Membership Fee Configurations <small>membership fee configurations report goes
                here...</small></h1>
        <div class="row no-print">
            <div class="col-md-12 hidden-print">
                <a href="{!! route('membershipfeeconfigurations.index') !!}"><button type="button" class="btn btn-inverse btn-icon btn-circle m-b-10"><i
        ...
        <div class="invoice">
            ...
            <div class="invoice-header">
                ...
                <div class="invoice-date">
                    <img src="{!! secure_asset('uploads/images/' . $membershipfeeconfigurationsdata['company'][0]->logo) !!}" width='100' height='100' />
                </div>
            </div>
