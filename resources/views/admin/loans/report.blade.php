    ...
    <div id='content' class='content'>
        ...
        <div class="row no-print">
            <div class="col-md-12 hidden-print">
                <a href="{!! route('loans.index') !!}"><button type="button" class="btn btn-inverse btn-icon btn-circle m-b-10"><i
        ...
        <div class="invoice">
            ...
            <div class="invoice-header">
                ...
                <div class="invoice-date">
                    <img src="{!! secure_asset('uploads/images/' . $loansdata['company'][0]->logo) !!}" width='100' height='100' />
                </div>
            </div>
