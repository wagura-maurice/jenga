                ...
                <div class="panel-body">
                    <form id="form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select onchange="subCounties()" class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="county" id="county">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="primary_phone_number" id="primary_phone_number" placeholder="(999) 999-9999" class="form-control" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Secondary Phone Number" class="col-sm-3 control-label">Secondary Phone Number</label>
                            <div class="col-sm-6">
                                <input type="text" name="secondary_phone_number" id="secondary_phone_number" class="form-control" placeholder="Secondary Phone Number" value="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
                                <button type="button" onclick="save()" class="btn btn-sm btn-primary" id="btn-save">
                                    <i class="fa fa-btn fa-plus"></i> Add Guarantors
                                </button>
                            </div>
                        </div>
                    </form>
