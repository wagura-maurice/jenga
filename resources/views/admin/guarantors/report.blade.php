    ...
    <div id='content' class='content'>
        ...
        <div class="row no-print">
            <div class="col-md-12 hidden-print">
                <a href="{!! route('guarantors.index') !!}"><button type="button"
            ...
            <div class="text-center" id="report-header">
                <table>
                    <tbody>
                        <tr>
                            <td></td>
                            <td><img src="{!! secure_asset('uploads/images/' . $guarantorsdata['company'][0]->logo) !!}" height='70px' /></td>
                            <td></td>
                        </tr>
                        <div class="invoice-date">
                            <tr>
                                ...
                                <td class="text-center" style="font-size:18px; font-weight:bold; color:#000;">
                                    {!! $guarantorsdata['company'][0]->name !!}</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">
                                    {!! $guarantorsdata['company'][0]->street !!} {!! $guarantorsdata['company'][0]->address !!}</td>
                                <td></td>
                            ...
                            <tr>
                                <td></td>
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">
                                    {!! $guarantorsdata['company'][0]->city !!}, {!! $guarantorsdata['company'][0]->zip_code !!}</td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">Phone:
                                    {!! $guarantorsdata['company'][0]->phone_number !!}</td>
                                <td></td>
