...
<div id="content" class="content">
    ...
    <h1 class="page-header">Mobile Money Charge Scales Update Form <small>mobile money charge scales details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{!! route('mobilemoneychargescales.update',$mobilemoneychargescalesdata['data']->id) !!}" method="POST" class="form-horizontal">
<input type="hidden" name="_method" value="put" />
                        {!! csrf_field() !!}
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="mobile_money_charge" id="mobile_money_charge">
                                            <option value="" >Select Mobile Money Charge</option>				                                @foreach ($mobilemoneychargescalesdata['mobilemoneychargeconfigurations'] as $mobilemoneychargeconfigurations)
				                                ...
				                                <option selected value="{!! $mobilemoneychargeconfigurations->id !!}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="minimum_amount" id="minimum_amount" class="form-control" placeholder="Minimum Amount" value="{!! $mobilemoneychargescalesdata['data']->minimum_amount !!}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Maximum Amount" class="col-sm-3 control-label">Maximum Amount</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="maximum_amount" id="maximum_amount" class="form-control" placeholder="Maximum Amount" value="{!! $mobilemoneychargescalesdata['data']->maximum_amount !!}">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="charge" id="charge" class="form-control" placeholder="Charge" value="{!! $mobilemoneychargescalesdata['data']->charge !!}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Edit Mobile Money Charge Scales
                                        </button>
                                    </div>
                                </div>
                    </form>
