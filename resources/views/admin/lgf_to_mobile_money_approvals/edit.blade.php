...
<div id="content" class="content">
    ...
    <h1 class="page-header">Lgf To Mobile Money Approvals Update Form <small>lgf to mobile money approvals details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="{!! route('lgftomobilemoneyapprovals.update',$lgftomobilemoneyapprovalsdata['data']->id) !!}" method="POST" class="form-horizontal">
<input type="hidden" name="_method" value="put" />
                        {!! csrf_field() !!}
                                    ...
                                    <div class="col-sm-6">
									    <select class="form-control selectpicker" data-size="100000" data-live-search="true" data-style="btn-white" name="mobile_money_transfer" id="mobile_money_transfer">
                                            <option value="" >Select Mobile Money Transfer</option>				                                @foreach ($lgftomobilemoneyapprovalsdata['lgftomobilemoneytransfers'] as $lgftomobilemoneytransfers)
				                                ...
				                                <option selected value="{!! $lgftomobilemoneytransfers->id !!}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <Textarea name="remarks" id="remarks" class="form-control" row="20" placeholder="Remarks" value="{!! $lgftomobilemoneyapprovalsdata['data']->remarks !!}">{!! $lgftomobilemoneyapprovalsdata['data']->remarks !!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Edit Lgf To Mobile Money Approvals
                                        </button>
                                    </div>
                                </div>
                    </form>
