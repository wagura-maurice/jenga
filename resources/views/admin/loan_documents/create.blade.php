                    ...
                    <form id="form"  class="form-horizontal" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="file"  name="document" id="document" class="form-control" placeholder="Document" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="button" onclick="save()" class="btn btn-sm btn-primary">
                                            <i class="fa fa-btn fa-plus"></i> Add Loan Documents
                                        </button>
                                    </div>
                                </div>
                    </form>
