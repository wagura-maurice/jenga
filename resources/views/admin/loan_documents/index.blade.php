        ...
        <div class="row">
            <div class="col-md-12">
                @if ($loandocumentsdata['usersaccountsroles'][0]->_add == 1)
                    <a href="{!! route('loandocuments.create') !!}"><button type="button"
                ...
                @if ($loandocumentsdata['usersaccountsroles'][0]->_report == 1)
                    <a href="{!! url('admin/loandocumentsreport') !!}"><button type="button"
                            class="btn btn-inverse btn-icon btn-circle m-b-10"><i
                                class="fa fa-file-text-o"></i></button></a>
                @endif
                @if (
                    $loandocumentsdata['usersaccountsroles'][0]->_report == 1 ||
                        $loandocumentsdata['usersaccountsroles'][0]->_list == 1)
                                        ...
                                        <td>
                                            <form action="{!! route('loandocuments.destroy', $loandocuments->id) !!}" method="POST">
                                                @if ($loandocumentsdata['usersaccountsroles'][0]->_show == 1)
                                                    <a href="{!! route('loandocuments.show', $loandocuments->id) !!}"
                                                        id='show-loandocuments-{!! $loandocuments->id !!}'
                                                        class='btn btn-sm btn-circle btn-inverse'>
                                                        <i class='fa fa-btn fa-eye'></i>
                                                    </a>
                                                @endif
                                                @if ($loandocumentsdata['usersaccountsroles'][0]->_edit == 1)
                                                    <a href="{!! route('loandocuments.edit', $loandocuments->id) !!}"
                                                        id='edit-loandocuments-{!! $loandocuments->id !!}'
                                                ...
                                                @if ($loandocumentsdata['usersaccountsroles'][0]->_delete == 1)
                                                    ...
                                                    {!! method_field('DELETE') !!}
                                                    <button type='submit'
                                                        id='delete-loandocuments-{!! $loandocuments->id !!}'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal" action="{!! url('admin/loandocumentsfilter') !!}"
                                        method="POST">
                                        {!! csrf_field() !!}
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" name="loan" id="loan">
                                                    ...
                                                    @foreach ($loandocumentsdata['loans'] as $loans)
