...
<div id="content" class="content">
    ...
    <h1 class="page-header">Clearing Fee Configurations - DATA <small>clearing fee configurations data goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
            @if($clearingfeeconfigurationsdata['usersaccountsroles'][0]->_add==1)
            <a href="{!! route('clearingfeeconfigurations.create') !!}"><button type="button" class="btn btn-inverse btn-icon btn-circle m-b-10"><i class="fa fa-plus"></i></button></a>
            @endif
            @if($clearingfeeconfigurationsdata['usersaccountsroles'][0]->_report==1)
            <a href="{!! url('admin/clearingfeeconfigurationsreport') !!}"><button type="button" class="btn btn-inverse btn-icon btn-circle m-b-10"><i class="fa fa-file-text-o"></i></button></a>
            @endif
            @if($clearingfeeconfigurationsdata['usersaccountsroles'][0]->_report==1 || $clearingfeeconfigurationsdata['usersaccountsroles'][0]->_list==1)
            <a href="#modal-dialog"  data-toggle="modal"><button type="button" class="btn btn-inverse btn-icon btn-circle m-b-10"><i class="fa fa-filter"></i></button></a>
            @endif
    @if($clearingfeeconfigurationsdata['usersaccountsroles'][0]->_list==1)
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                        @foreach ($clearingfeeconfigurationsdata['list'] as $clearingfeeconfigurations)
                            <tr>
                                <td class='table-text'><div>
                                	{!! $clearingfeeconfigurations->loanproductmodel->name !!}
                                </div></td>
                                <td class='table-text'><div>
                                ...
                                <td class='table-text'><div>
                                	{!! $clearingfeeconfigurations->paymentmodemodel->name !!}
                                </div></td>
                                <td class='table-text'><div>
                ...
                <form action="{!! route('clearingfeeconfigurations.destroy',$clearingfeeconfigurations->id) !!}" method="POST">
                                        ...
                                        <a href="{!! route('clearingfeeconfigurations.show',$clearingfeeconfigurations->id) !!}" id='show-clearingfeeconfigurations-{!! $clearingfeeconfigurations->id !!}' class='btn btn-sm btn-circle btn-inverse'>
                                            <i class='fa fa-btn fa-eye'></i>
                                        </a>
                                        @endif
                                        @if($clearingfeeconfigurationsdata['usersaccountsroles'][0]->_edit==1)
                                        <a href="{!! route('clearingfeeconfigurations.edit',$clearingfeeconfigurations->id) !!}" id='edit-clearingfeeconfigurations-{!! $clearingfeeconfigurations->id !!}' class='btn btn-sm btn-circle btn-warning'>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Clearing Fee Configurations - Filter Dialog</h4>
            </div>
    			...
    			<div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            ...
                            <div class="panel-body">
                    <form id="form"  class="form-horizontal" action="{!! url('admin/clearingfeeconfigurationsfilter') !!}" method="POST">
                        {!! csrf_field() !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="submit" class="btn btn-sm btn-inverse">
                                            <i class="fa fa-btn fa-search"></i> Search Clearing Fee Configurations
                                        </button>
                                    </div>
                                </div>
                    </form>
