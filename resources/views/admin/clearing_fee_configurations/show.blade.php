...
@section('main_content')
    ...
    <h1 class="page-header">Clearing Fee Configurations Form <small>clearing fee configurations details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="profile-info">
                            <div class="table-responsive">
                                <table class="table table-profile">
                                    <thead>
                                    	<tr class="highlight">
                                    		<td>Clearing Fee Configurations</td>
                                    		<td>Profile Data</td>
                                    	</tr>
                                        <tr class="divider">
                                            <td colspan="2"></td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($clearingfeeconfigurationsdata['loanproducts'] as $loanproducts)
                                        ...
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($clearingfeeconfigurationsdata['feetypes'] as $feetypes)
                                        ...
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($clearingfeeconfigurationsdata['feepaymenttypes'] as $feepaymenttypes)
                                        ...
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($clearingfeeconfigurationsdata['paymentmodes'] as $paymentmodes)
                                        ...
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($clearingfeeconfigurationsdata['disbursementmodes'] as $disbursementmodes)
                                        ...
                                        <tr>
                                            ...
                                            <td>				                                @foreach ($clearingfeeconfigurationsdata['accounts'] as $accounts)
