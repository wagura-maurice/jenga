...
@section('main_content')
    ...
    <h1 class="page-header">Lgf Types Form <small>lgf types details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                                ...
                                <table class="table table-profile">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                            {!! $lgftypesdata['data']->code !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="field">Name</td>
                                            <td>
                                            {!! $lgftypesdata['data']->name !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="field">Description</td>
                                            <td>
                                            {!! $lgftypesdata['data']->description !!}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
