...
<div id='content' class='content'>
            ...
            <h1 class="page-header hidden-print">Interest Payment Methods <small>interest payment methods report goes here...</small></h1>
            ...
            <div class="invoice">
                ...
                <div class="invoice-header">
                    ...
                    <div class="invoice-date">
                        <img src="{!!asset('uploads/images/'.$interestpaymentmethodsdata['company'][0]->logo)!!}" width='100' height='100'/>
                    </div>
                </div>
