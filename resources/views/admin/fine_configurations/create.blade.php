...
<div id="content" class="content">
    ...
    <h1 class="page-header">Fine Configurations Form <small>fine configurations details goes here...</small></h1>
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button type="button" onclick="save()" class="btn btn-sm btn-primary" id="btn-save">
                                            <i class="fa fa-btn fa-plus"></i> Add Fine Configurations
                                        </button>
                                    </div>
                                </div>
                    </form>
...
function save(){
	...
	$.ajax({
		type:'POST',
		url: "{!! route('fineconfigurations.store')!!}",
		data:formData,
		cache:false,
		contentType: false,
		processData: false,
