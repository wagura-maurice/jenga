...
@section('main_content')
    ...
    <div id='content' class='content'>
        ...
        <h1 class="page-header hidden-print">Disbursement Charges Configurations <small>disbursement charges configurations
                report goes here...</small></h1>
        <div class="row no-print">
            <div class="col-md-12 hidden-print">
                <a href="{!! route('disbursementchargesconfigurations.index') !!}"><button type="button"
            ...
            <div class="text-center" id="report-header">
                <table>
                    <tbody>
                        <tr>
                            <td></td>
                            <td><img src="{!! secure_asset('uploads/images/' . $disbursementchargesconfigurationsdata['company'][0]->logo) !!}" height='70px' /></td>
                            <td></td>
                        </tr>
                        <div class="invoice-date">
                            <tr>
                                ...
                                <td class="text-center" style="font-size:18px; font-weight:bold; color:#000;">
                                    {!! $disbursementchargesconfigurationsdata['company'][0]->name !!}</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">
                                    {!! $disbursementchargesconfigurationsdata['company'][0]->street !!} {!! $disbursementchargesconfigurationsdata['company'][0]->address !!}</td>
                                <td></td>
                            ...
                            <tr>
                                <td></td>
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">
                                    {!! $disbursementchargesconfigurationsdata['company'][0]->city !!}, {!! $disbursementchargesconfigurationsdata['company'][0]->zip_code !!}</td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="color:#000; font-weight: bold; font-family: segoi-ui;">Phone:
                                    {!! $disbursementchargesconfigurationsdata['company'][0]->phone_number !!}</td>
                                <td></td>
