 ...
 @section('content')
     ...
     <div class="login-cover">
         <div class="login-cover-image"><img src="{{ asset('assets/admin//img/login-bg/bg-6.jpg') }}"
     ...
     <div id="page-container" class="fade">
         ...
         <ul class="login-bg-list clearfix">
             <li><a href="#" data-click="change-bg"><img src="{{ asset('assets/admin//img/login-bg/bg-1.jpg') }}"
                         alt="" /></a></li>
             <li><a href="#" data-click="change-bg"><img src="{{ asset('assets/admin//img/login-bg/bg-2.jpg') }}"
                         alt="" /></a></li>
             <li><a href="#" data-click="change-bg"><img src="{{ asset('assets/admin//img/login-bg/bg-3.jpg') }}"
                         alt="" /></a></li>
             <li><a href="#" data-click="change-bg"><img src="{{ asset('assets/admin//img/login-bg/bg-4.jpg') }}"
                         alt="" /></a></li>
             <li><a href="#" data-click="change-bg"><img src="{{ asset('assets/admin//img/login-bg/bg-5.jpg') }}"
                         alt="" /></a></li>
             <li class="active"><a href="#" data-click="change-bg"><img
                         src="{{ asset('assets/admin//img/login-bg/bg-6.jpg') }}" alt="" /></a></li>
         </ul>
