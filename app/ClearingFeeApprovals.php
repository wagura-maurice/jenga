...
*Model - (manages clearing fee approvals data)
*/
namespace App;
use Illuminate\Database\Eloquent\Model;
class ClearingFeeApprovals extends Model
{
	public function transactionreferencemodel(){
		return $this->belongsTo(ClearingFeePayments::class, 'transaction_reference');
	}
